...
dependencies {
  ...
  implementation("org.jmailen.kotlinter:org.jmailen.kotlinter.gradle.plugin:5.5.0")
  implementation("org.gradle.kotlin:gradle-kotlin-dsl-plugins:$expectedKotlinDslPluginsVersion")
  implementation("org.pitest:pitest:1.25.5")
  implementation("com.groupcdg.gradle:common:1.0.7")
  implementation("info.solidsoft.gradle.pitest:gradle-pitest-plugin:1.19.0")
  implementation("com.arcmutate.github:com.arcmutate.github.gradle.plugin:2.3.3")

  internalDeps("org.junit.jupiter:junit-jupiter:6.1.0")
